...
import { Engine, Scene, ArcRotateCamera, Vector3, HemisphericLight, MeshBuilder, RichType, FreeCamera, Color4, Color3 } from "@babylonjs/core";
...
export class App {
    ...
    private async initializeScene() {
        ...
        const camera: FreeCamera = new FreeCamera("Camera", new Vector3(-0.1,1, 2.8), scene);
       ...
       // Create and position Hemispheric Light
        ...
        const light1: HemisphericLight = new HemisphericLight("light1", lightDirection, scene);
       ...
       // this.App_Gui.chatUI();
          ...
          this.tts = new TextToSpeech(this.subscriptionKey, this.serviceRegion);

          //Initialize questionAnswer
          this.questionAnswer = new CustomerService();  //object of CustomerService class    

            //chat Ui
            this.chatUI=new ChatUI(this,this.tts,this.stt,this.avatarLoader,this.questionAnswer);
    ...
    private setupUI() {
       ...
       ttsButton.addEventListener("click", () => {
           ...
           if (answer) {
               ...
               this.tts.speakText(answer,this.onSpeakingStarted,this.onSpeakingEnded);
               askQuestionInput.innerText = answer;
           }
       });

       // Speech to Text
       const sttButton = document.getElementById("stt-button") as HTMLButtonElement;
           ...
           if (this.isRecording) {
              ...
              // sttOutput.innerText = "Listening...";
               this.stt.startRecognition((text: string) => {
                   ...
                   const answer = this.questionAnswer.getAnswer(askQuestionInput.innerText);
                   if (answer) {
                       ...
                       this.tts.speakText("Sorry, we couldn't find an answer to your question.",this.onSpeakingStarted,this.onSpeakingEnded);
                   }
                   this.stt.stopRecognition();
               });
           }
